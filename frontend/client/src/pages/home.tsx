...
export default function Home() {
  ...
  // 🔹 Location state for controlling when we render the grid
  ...
  useEffect(() => {
    ...
    // Here we just wait until those values appear.
    let tries = 0;
    const maxTries = 15; // ~4.5s if interval is 300ms
    ...
    const interval = setInterval(() => {
      ...
      if (latStr && lngStr) {
        setUserLat(parseFloat(latStr));
        setUserLng(parseFloat(lngStr));
        setLocationReady(true);
        clearInterval(interval);
      } else {
        tries++;
        if (tries >= maxTries) {
          // Give up waiting; mark ready (grid will handle “no location” case)
          setLocationReady(true);
          clearInterval(interval);
        }
      }
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Connecting consumers, retailers, and wholesalers with real-time
                medicine availability and seamless ordering.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/search">
                  <Button
                    className="bg-white text-primary px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
                    data-testid="button-order-medicine"
                  >
                    Order Medicine
                  </Button>
                </Link>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <Link href="/search">
              <div
                ...
                data-testid="action-order-medicine"
              >
            ...
            <div
              className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow cursor-pointer text-center"
              data-testid="action-upload-prescription"
            >
      ...
      <section className="py-16 bg-muted/30" data-testid="featured-medicines">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {!locationReady ? (
            <p className="text-sm text-muted-foreground">
              Detecting your location to show nearby stores...
            </p>
          ) : (
            <CustomerMedicinesGrid userLat={userLat} userLng={userLng} />
          )}
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30" data-testid="trust-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              Trusted by thousands of customers, retailers, and wholesalers
            </p>
          </div>
          ...
          >
            <div className="text-center" data-testid="badge-authentic">
              ...
              <p className="text-muted-foreground">
                All medicines are sourced directly from authorized distributors
              </p>
            </div>
            ...
            <div className="text-center" data-testid="badge-delivery">
              ...
              <p className="text-muted-foreground">
                Get your medicines delivered within 2-24 hours
              </p>
            </div>
            ...
            <div className="text-center" data-testid="badge-licensed">
              ...
              <p className="text-muted-foreground">
                All partner pharmacies are licensed and verified
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div data-testid="footer-brand">
              ...
              <p className="text-gray-300 mb-4">
                Your trusted partner for all medicine needs. Connecting
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li>
                  <a
                    href="#"
                    className="hover:text-white transition-colors"
                    data-testid="footer-link-prescription"
                  >
                    Upload Prescription
                  </a>
                </li>
                <li>
                  <a
                    href="#"
                    className="hover:text-white transition-colors"
                    data-testid="footer-link-consult"
                  >
                    Consult Doctor
                  </a>
                </li>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              >{`© 2024 MedEasy. All rights reserved.`}</p>
              <div className="flex space-x-6 mt-4 md:mt-0">
                ...
                <a
                  href="#"
                  className="text-gray-400 hover:text-white transition-colors"
                  data-testid="footer-link-terms-service"
                >
                  Terms of Service
                </a>
                <a
      ...
      <div
        className="fixed bottom-0 left-0 right-0 bg-white border-t border-border md:hidden z-40"
